...
cmp_results "medium mixed" "1+2+3-2+2-100"
cmp_results "long mixed" "1+2*3+4/5+6%2-2+1*2%2/2+1/2"
...
cmp_results "hard mixed" "2+2*3+2-4/2+1+2-9/22%8+10-10/2+2*44"
cmp_results "hard mixed" "2+22221*3+2987-45678/22213+14232+2322-9/2222%834+1330-12130/4452+2*42324"
